 ...
 * @author erosi
 */
public class CambioUserN_1 extends javax.swing.JFrame {

    /** Creates new form CambioUserN */
    public CambioUserN_1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CambioUserN_1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CambioUserN_1().setVisible(true);
            }
        });
    }
